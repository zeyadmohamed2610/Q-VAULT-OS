# Contributing to Q-Vault OS

First off, thank you for considering contributing to Q-Vault OS! It's people like you that make Q-Vault such a great tool.
...
5. Make sure your code follows the project's coding style (PEP8 for Python).
