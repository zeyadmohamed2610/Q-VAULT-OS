...
class FileExplorerProxy(QWidget):
    ...
    def __init__(self, secure_api=None, parent=None, start_path=None):
        ...
        from ui.apps.file_manager.file_manager_app import FileManagerApp
...
class TerminalProxy(IsolatedAppWidget):
    ...
    def __init__(self, secure_api=None, parent=None):
        super().__init__(
            app_id="Terminal",
            module_path="ui.apps.terminal.terminal_engine",
        ...
        from ui.apps.terminal.terminal_app import TerminalWidget
