...
class SudoDialog(QDialog):
    ...
    def paintEvent(self, event):
        ...
        # ── Glassmorphic Fill ──
        bg_color = QColor(THEME['bg_dark'])
        bg_color.setAlpha(220)
        painter.setBrush(bg_color)
        painter.setPen(QPen(QColor(THEME['warning']), 1.2))
...
class SudoPasswordDialog(QDialog):
    ...
    def _build_ui(self, title: str, message: str):
        ...
        container.setStyleSheet("""
            QWidget {
                background-color: rgba(11, 25, 41, 0.85);
                color: #d4e8f0;
            }
    ...
    def paintEvent(self, event):
        ...
        painter.fillPath(path, QColor(11, 25, 41, 220))
        painter.setPen(QPen(QColor(0, 200, 255, 100), 1.2))
