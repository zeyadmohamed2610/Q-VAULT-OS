...
class DirectiveEngine {
  ...
  // Scene-specific directives — sovereignty table
  private readonly SCENE_DIRECTIVES: Record<number, Partial<DirectiveState>> = {
    0:  { sceneDwellMultiplier: 1.4, restraintFactor: 0.9, silenceDepth: 0.8, tensionVector: -0.2 },
    1:  { sceneDwellMultiplier: 1.0, restraintFactor: 0.6, silenceDepth: 0.3, tensionVector: 0.3 },
    2:  { sceneDwellMultiplier: 1.5, restraintFactor: 0.8, silenceDepth: 0.5, tensionVector: -0.1 },
    3:  { sceneDwellMultiplier: 1.2, restraintFactor: 0.7, silenceDepth: 0.3, tensionVector: 0.0 },
    4:  { sceneDwellMultiplier: 1.1, restraintFactor: 0.7, silenceDepth: 0.2, tensionVector: 0.1 },
    5:  { sceneDwellMultiplier: 1.6, restraintFactor: 1.0, silenceDepth: 0.9, tensionVector: -0.3 }, // Zero Knowledge — sacred
    6:  { sceneDwellMultiplier: 1.2, restraintFactor: 0.65, silenceDepth: 0.2, tensionVector: 0.2 },
    7:  { sceneDwellMultiplier: 1.1, restraintFactor: 0.6, silenceDepth: 0.1, tensionVector: 0.2 },
    8:  { sceneDwellMultiplier: 1.2, restraintFactor: 0.75, silenceDepth: 0.3, tensionVector: 0.1 },
    9:  { sceneDwellMultiplier: 0.85, restraintFactor: 0.4, silenceDepth: 0.0, tensionVector: 0.9 }, // Threat — fastest
    10: { sceneDwellMultiplier: 1.4, restraintFactor: 0.85, silenceDepth: 0.5, tensionVector: -0.2 },
    11: { sceneDwellMultiplier: 1.6, restraintFactor: 0.9, silenceDepth: 0.7, tensionVector: -0.3 },
    12: { sceneDwellMultiplier: 2.2, restraintFactor: 1.0, silenceDepth: 1.0, tensionVector: -0.8 }, // Seal — eternal
  };
