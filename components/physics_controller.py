# =============================================================
#  components/physics_controller.py — Q-Vault OS
#
#  The Window Physics Engine. Handles Drag, Velocity, Snap,
#  and Inertia logic for OSWindows.
# =============================================================
...
class PhysicsController(QObject):
    ...
    def _check_snap(self, mouse_pos):
        ...
        if my <= self.SNAP_THRESHOLD:
            ...
            if my >= h - self.SNAP_THRESHOLD: new_slot = WindowSlot.QUARTER_BL
            elif my <= self.SNAP_THRESHOLD + 40: new_slot = WindowSlot.QUARTER_TL
            else: new_slot = WindowSlot.HALF_LEFT
        elif mx >= w - self.SNAP_THRESHOLD:
            if my >= h - self.SNAP_THRESHOLD: new_slot = WindowSlot.QUARTER_BR
            elif my <= self.SNAP_THRESHOLD + 40: new_slot = WindowSlot.QUARTER_TR
            else: new_slot = WindowSlot.HALF_RIGHT
